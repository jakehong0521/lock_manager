...
public class TestLockManager {
    ...
    public void testTableImmediateUpgrade() {
        ...
        assertTrue("true", lockMan.holds(t1, r1, LockManager.LockType.S));

        lockMan.acquire(t1, r1, LockManager.LockType.X);

        assertFalse("false", lockMan.holds(t1, r1, LockManager.LockType.S));
        assertTrue("true", lockMan.holds(t1, r1, LockManager.LockType.X));
    }
